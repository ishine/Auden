...
from auden.models.lalm.model import LalmModel, EncoderProjector, compute_accuracy, IGNORE_TOKEN_ID, CHAT_TEMPLATE
from auden.auto.auto_model import AutoModel
from auden.models.lalm.utils import replace_whisper_encoder_forward
...
class AudioLLMDualAudioTokensModel(LalmModel):
    ...
    def __init__(self, config, tokenizer):
        ...
        if self.voice_encoder_type == "whisper":
            ...
            # Zipformer or other Auden models
